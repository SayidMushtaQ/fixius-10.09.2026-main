    ...
    <main className="min-h-screen bg-mainBackground pt-24 pb-20">
      ...
      <section className="Container text-center space-y-8 mb-12">
        ...
        <p className="max-w-3xl mx-auto text-lg text-gray-600 font-medium leading-relaxed">
          Suchst du einen {serviceTitle} in {cityDisplay}? Unsere Plattform verbindet dich direkt mit geprüften Handwerkern aus deiner Nähe. Vergleiche  Angebote und wähle den idealen Experten für deine Bedürfnisse.
        </p>
      </section>
