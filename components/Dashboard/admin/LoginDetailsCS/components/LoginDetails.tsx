  ...
  return (
    <div className="w-full p-6 lg:p-10">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-black text-secondary">Anmeldedaten (Kunde)</h1>
          <p className="text-gray-500 mt-1">Überblick über die letzten Login-Aktivitäten der Kunden.</p>
        </div>
      </div>
